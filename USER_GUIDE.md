...
config :my_app, MyApp.Web.Endpoint,
  inertia: [
    # The `:auto`, string or the MFA to generate a string, which is used for assets versioning.
    # Default to `:auto`, which means detecting assets version in following order:
    #  * check and hash the manifest file generated by Vite.
    #  * check and hash the manifest file generated by `combo.static.digest`.
    #  * fallback to `"1"`.
    assets_version: :auto,
